...
public class MealServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action == null) {
            LOG.info("getAll");
            request.setAttribute("mealList", getUserMealsWithExceed());
    ...
    private List<UserMealWithExceed> getUserMealsWithExceed() {
        return UserMealsUtil.getFilteredMealsWithExceeded(repository.getAll(), LocalTime.MIN, LocalTime.MAX, 2000);
    }
}